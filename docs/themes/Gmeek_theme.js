...
/* 背景图片 */
html {
    background: url('https://c.wallhere.com/photos/1e/a9/animals_cats-2300332.jpg!d') no-repeat center center fixed;
...
body {
    ...
    line-height: 1.25;
    background: rgba(0, 0, 0, 0.8); /* 黑色背景，透明度80% */
    border-radius: 10px; /* 圆角边框 */
    box-shadow: 0 0 10px rgba(0, 0, 0, 0.5); /* 添加阴影 */
    overflow: auto;
}
.SideNav {
    background: rgba(0, 0, 0, 0.6); /* 黑色背景，透明度60% */
    border-radius: 10px; /* 圆角边框 */
    min-width: unset;
}
.SideNav-item:hover {
    background-color: #0000FF; /* 光标悬浮在博客时显示为蓝色 */
    border-radius: 10px;
